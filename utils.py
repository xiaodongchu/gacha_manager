...
logger.add(now_dir + "log/log.txt", level="INFO", rotation="04:00", encoding="utf-8", enqueue=True)
...
def backup_and_merge_genshin(uid, new_df: pandas.DataFrame):
    ...
    new_df = new_df.sort_values(by=["time"], ascending=False, ignore_index=True)
